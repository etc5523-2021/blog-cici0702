...
The number of weekly new cases of different ages shows that the age between 0 - 19 has the highest infection rate among all the age groups. The numbers of all ages suffer the same trend with the whole country according to the pandemic wave. One of the reason that why young ages has the largest number of cases, is that this group of people is the latest group to get vaccinated. According to [Wikipedia](https://en.wikipedia.org/wiki/COVID-19_vaccination_in_Israel), the people between 60 to 70 are the first group to get vaccinated. In this graph it's hard to define this group of people. The second largest age group is people between 70 to 74, which in yellow line. The reason is that people are easily to get infected. Other groups of people has good ablity of immunity, therefore the cases are not that much.

In Wikipedia, the vaccination rate of Israel has reached the top world highest vaccination rate per capita with good speed and number of vaccinations. However, Israel still faced four pandemic waves. Let's look at the surrounding countries.
